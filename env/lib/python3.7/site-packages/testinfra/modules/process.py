...
class Process(InstanceModule):
    ...
    >>> master = host.process.get(user="root", comm="nginx_role")
    # Here is the master nginx_role process (running as root)
    >>> master.args
    'nginx_role: master process /usr/sbin/nginx_role -g daemon on; master_process on;'
