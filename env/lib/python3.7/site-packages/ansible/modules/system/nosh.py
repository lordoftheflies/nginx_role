...
- name: for package installers, set nginx_role running state according to local enable settings, preset and reset
  nosh: name=nginx_role preset=True state=reset
