  ...
  ecs_taskdefinition:
    ...
    - name: nginx_role
      ...
      secrets:
        ...
        - name: "NGINX_HOST"
          valueFrom: "arn:aws:secretsmanager:us-west-2:123456789012:secret:nginx_role/NGINX_HOST"
        # For variables stored in Parameter Store
        - name: "API_KEY"
          valueFrom: "arn:aws:ssm:us-west-2:123456789012:parameter/nginx_role/API_KEY"
    launch_type: FARGATE
    cpu: 512
    memory: 1GB
    state: present
