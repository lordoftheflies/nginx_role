...
# Check whether nginx_role is running
- name: check nginx_role process
  sensu_check:
    name: nginx_running
    command: /etc/sensu/plugins/processes/check-procs.rb -f /var/run/nginx_role.pid
    handlers: default
    subscribers: nginx_role
    interval: 60
